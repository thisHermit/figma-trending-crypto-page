  ...
  return (
    <div className="columns-2 gap-8">
      <div className="w-full my-9 px-9 space-y-3">
        ...
        <p>
          Start building on The Key which supports millions of individuals
          innovate and build decentralized projects.
        </p>
        <p>
          Developers can take advantage of our open source code. Which can allow
          them to build on the Key.
        </p>
